...
//
// Interface to the A2DP FLAC Encoder
//

#ifndef A2DP_VENDOR_FLAC_ENCODER_H
#define A2DP_VENDOR_FLAC_ENCODER_H

#include "a2dp_codec_api.h"
#include "osi/include/time.h"

// Loads the A2DP FLAC encoder.
// Return true on success, otherwise false.
bool A2DP_VendorLoadEncoderFlac(void);

// Unloads the A2DP FLAC encoder.
void A2DP_VendorUnloadEncoderFlac(void);

// Initialize the A2DP FLAC encoder.
